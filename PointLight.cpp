...
//Recibe Color nuevo RGB, dirección nueva
void PointLight::SetLight(glm::vec3 colorNuevo, glm::vec3 position)
{
	color = colorNuevo;
}

//Recibe la intesidad ambiental y difusa
void PointLight::SetIntensity(GLfloat ambientIntensityNuevo, GLfloat diffuseIntensityNuevo) 
{
